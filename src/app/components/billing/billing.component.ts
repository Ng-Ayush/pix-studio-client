...
export class BillingComponent {
  ...
  showDeleteInvoiceModal: boolean = false;
  currentInvoiceId: any= '';
  showActionDropDown: any = {};

  constructor(private billingService: BillingService, private elementRef: ElementRef, private loader: LoaderService, private router: Router, private alert: AlertService, private adminService: AdminService) {
  ...
  deleteInvoice(){
    this.billingService.deleteInvoice(this.currentInvoiceId,(res:any)=>{
      if(res.status == 200){
        this.showDeleteInvoiceModal = false;
        this.showActionDropDown = {};
        this.alert.success(res.message);
