...
export class BaseService {
  ...
  httpUrls: any = {
    ...
    'deleteEvent': '/api/mystudio/photos/deleteEvent',
    ...
    'deleteFolder': '/api/mystudio/photos/deleteFolder',
    ...
    'deletePhotos': '/api/mystudio/photos/deletePhotos',
    ...
    'deletePastPaymentByInvoiceIdAndPaymentId': '/api/mystudio/invoices/deletePastPaymentByInvoiceIdAndPaymentId',
